...
- create or resume an isolated issue worktree
...
- issue-worktree-specific code intelligence runs inside the worktree
...
- local LeanKG in implementation issue worktrees
