...
- Stop at `closeout` if PR merge, moved old-ID implementation evidence, squash/import release file/content evidence, mainline, or CI evidence is missing; keep `llm-review` until closeout is proven.
